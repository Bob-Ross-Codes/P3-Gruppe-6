...
public class GazeCalibration : MonoBehaviour
{
    ...
    public bool stopAfterPoints = false;
    ...
    void Start()
    {
        ...
        _presets = new List<CalibrationPreset> { //new CirclePreset(padding, 500f, 90, out _stop),
    ...
    private void DrawPath(List<Vector2> waypoints)
    {
        ...
        {
            path.SetPosition(pointCounter, path.transform.parent.InverseTransformPoint(waypoint));
            pointCounter++;
        }
    }
